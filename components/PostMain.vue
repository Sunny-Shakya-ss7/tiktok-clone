    ...
    <div id="PostMain" class="flex border-b py-6">
        ...
        <div class="pl-3 w-full px-4">
            <div class="flex items-center justify-center pb-0.5">
                ...
                <button
                    class="border text-[15px] px-[21px] py-0.5 border-[#F02C56] text-[#F02C56] hover:bg-[#ffeef2] font-semibold rounded-md">Follow</button>
            </div>

            <div class="text-[15px] pb-0.5 break-words md:max-w-[480px] max-w-[300px]">
                This is some text
            </div>
