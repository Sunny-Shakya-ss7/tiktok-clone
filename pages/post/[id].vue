<template>
    <div id="PostPage"
        class="fixed lg:flex justify-between z-50 top-0 left-0 w-full b-full bg-black lg:overflow-hidden overflow-auto">
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <video v-if="true" class="absolute object-cover w-full my-auto z-[-1] h-screen" src="../../public/video1.mp4" />
            ...
            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" ref="video" loop muted class="h-screen mx-auto" src="../../public/video1.mp4" />
            </div>
        </div>
        ...
        <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
            ...
            <div class="flex items-center px-8 mt-8">
                ...
                <div class="pb-4 text-center flex items-center">
                    ...
                    <span class="text-xs pl-2 pr-4 text-gray-800 font-semibold">64</span>
                </div>
            </div>
            ...
            <div id="Comments" class="bg-[#F8F8F8] z-0 w-full h-[calc(100%-273px)] border-t-2 overflow-auto">
                ...
                <div v-if="flase" class="text-center mt-6 text-xl text-gray-500">
                    No comments...
                </div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae reprehenderit earum
                                omnis provident officia, corrupti autem debitis sed reiciendis commodi placeat assumenda
                                quisquam ex sunt quaerat. Sapiente maxime qui consectetur!
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="CreateComment" v-if="true"
                ...
                <button :disabled="!comment" @click="addComment()"
                    ...
                    class="font-semibold text-sm ml- pr-1">
                    Post
                </button>
            </div>
        </div>
