    ...
    <UploadLayout>
        <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
            ...
            <div class="mt-8 md:flex gap-6">
                <label v-if="!fileDisplay" for="fileInput" @drop.prevent="onDrop" @dragover.prevent="$event => 1"
                ...
                <div class="mt-4 mb-6">
                    <div class="flex bg-[#F8F8F8] py-4 px-6">
                        <div>
                            <Icon class="mr-4" name="mdi:box-cutter-off" />
                        </div>
                        <div>
